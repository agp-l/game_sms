...
window.storyData = {
    ...
    "scenes": {
        "scena_1": {
            "contactId": "manzelka",
            "editor": {
                "x": 402.16666666666697,
                "y": 1738.3333333333337
            },
            "messages": [
                {
                    "type": "npc",
                ...
                {
                    "type": "npc",
                    "text": "Mohl by jsi mi změnit heslo pro Google účet?"
                },
                {
                    "type": "npc",
                    "text": "A když už tě tu mám! Už jsi napsal sousedovy aby mi posekl tu trávu před domem? Už mě to nebaví! "
                }
            ],
            "choices": [
                {
                    "text": "Dobře, ale vůbec se mi to teď nehodí. Musím za do hodiny vytvořit analýzu. ",
                    "next": "scena_522"
                },
                {
                    "text": "Už zase? :D Jo, za hodinku, teď nemohu. Analyzuji sluneční erupce a nezvykle nebezpečně zvýšenou aktivitu. ",
                    "next": "scena_508"
                },
                {
                    "text": "Teď nemohu. Po práci ti napíši.",
                    "next": "",
                    "changeChapter": {
                        "script": "story2.js",
                        "bg": "bg2.jpg",
        ...
        "scena_klid": {
            ...
            "messages": [
                {
                    "type": "npc",
                    "text": "U mobilu? Vždyť ho má vypnutý! Volám mu každých pět minut!"
                },
                {
                    "type": "npc",
                ...
                {
                    "type": "npc",
                    "text": "Zkusím zavolat k Davidovy. Možná hrají na Playstationu. Pokud tam nebude, volám policii. Pak napíšu."
                }
            ],
            "choices": [
                {
                    "text": "OK, asi máš pravdu. ",
                    "next": "scena_manzelka_ceka"
                }
            ]
        },
        "scena_manzelka_ceka": {
        ...
        "scena_panika_policie": {
            ...
            "choices": [
                {
                    "text": "(Čekat na kontaktování ze strany policie)",
        ...
        "scena_508": {
            ...
            "choices": [
                {
                    "text": "Zpět na kontakty",
                    "next": "BACK_TO_CONTACTS",
                    "unlocks": "policie_nevedomi"
                }
            ]
        },
        "policie_nevedomi": {
            ...
            "messages": [
                ...
                {
                    "type": "npc",
                    "text": "Dobrý večer, vaše manželka nahlásila ztrátu vašeho syna. "
                },
                {
                    "type": "npc",
                    "text": ""
        ...
        "scena_522": {
            "contactId": "manzelka",
            "editor": {
                "x": 1059.1666666666672,
                "y": 1752.3333333333337
            },
            "messages": [],
            "choices": [
                {
                    "text": "Pošlu ti heslo přes SMS, už to mám! :) ",
                    "next": "scena_180"
                },
                {
                    "text": "Proč potřebuješ heslo k Google účtu když jej nepoužíváš?  ",
                    "next": "helena_ztrata"
                }
            ]
        },
        "scena_180": {
            "contactId": "manzelka",
            "editor": {
                "x": 1508.1666666666672,
                "y": 1404.3333333333337
            },
            "messages": [],
            "choices": [
                {
                    "text": "Potřebuješ ještě něco?",
                    "next": "helena_ztrata"
                },
                {
                    "text": "Analyzuji sluneční erupce a nezvykle nebezpečně zvýšenou aktivitu. Napíši ti po práci. ",
                    "next": "policie_nevedomi"
                }
            ]
        },
        "helena_ztrata": {
            ...
            "editor": {
                "x": 2516.666666666667,
                "y": 1811.3333333333333
            },
            "messages": [
                {
                    "type": "npc",
                    "text": "Eliášek se nevrátil domů ze školy. Chci vyhledat lokaci jeho mobilu."
                },
                {
                    "type": "npc",
                    "text": "V družině prý byl, ale pak už jej nikdo neviděl. "
                },
                {
                    "type": "npc",
                    "text": "Co mám dělat? Co když se mu něco stalo!"
                }
            ],
            "choices": [
                {
                    "text": "Klid, Heleno. Určitě se jen někde zapomněl s klukama u mobilu. Však víš, jaký je. Zbytečně ho zase nepruď. ",
                    "next": "scena_klid"
                },
                {
                    "text": "Už brzy bude večer a venku mrzne. Okamžitě volej policii. Fakt na nic nečekej.",
                    "next": "scena_panika_policie"
                }
            ]
        }
    },
...
window.storyData.instagram = {
    "elias_syn": {
        name: "Eliáš",
        avatar: "eliasek.png", // <--- NOVÉ (náhledová fotka)
        bio: "Skaut. Urbex. Programování. Pózování 📸",
        followers: "128",
        following: "145",
        posts: [
          { img: "eliasek9.png", desc: "S Filipem jsem byl 14 dní na vodě. To byla brutální jízda!", likes: 2 },
          { img: "eliasek7.png", desc: "Takto vypadá moje maka úplně zoufalá.", likes: 2 },
          { img: "eliasek3.png", desc: "Vytvářím počítačové hry, je to brutálně super kurz. Filip je nejlepší učitel.", likes: 24 },
          { img: "eliasek5.png", desc: "Programování počká. Dneska jsme s Filipem stavěli hráz v potoce.", likes: 5 },
          { img: "eliasek6.png", desc: "S Filipem jsem byl koupališti. Byla brutálně teplá voda!", likes: 2 },
          { img: "eliasek1.png", desc: "Tímto lesem chodím ze škole domů. Jednou jsem tu našel kostru krtka.", likes: 24 },
          { img: "eliasek4.png", desc: "Moje tajné místo.", likes: 4 },
          { img: "eliasek2.png", desc: "Zase s Tátou na průzkumu. Tahle stará chata je fakt creepy. Našli jsme tam divný věci...", likes: 24 },
          { img: "eliasek8.png", desc: "S tátou na výletě. Prý pojede na dva roky na expedici.", likes: 24 }
        ]
    },
    "matka_helena": {
        name: "Helena (Máma)",
        avatar: "helena.png", // <--- NOVÉ (náhledová fotka)
        bio: "Káva. Rodina. Klid. ☕❤️",
        followers: "89",
        following: "50",
        posts: [
            { img: "helena3.png", desc: "Dnes ráno mě vyfotila sousedka. Vůbec jsem o tom nevěděla.", likes: 12 },
            { img: "helena4.png", desc: "Mám skvělého manžela, opět zařídil další výlet.", likes: 12 },
            { img: "helena2.png", desc: "Už v našem novém domě.", likes: 12 },
            { img: "helena1.png", desc: "Po deseti letech jsme si řekli ANO.", likes: 12 }
        ]
    },
    "instruktor_filip": {
        ...
        following: "120",
        posts: [
            { img: "instruktor1.png", desc: "Základy přežití. Vždy buďte připraveni na nejhorší.", likes: 45 },
            { img: "instruktor2.png", desc: "Jsem instruktor a lektor už přes 20 let.", likes: 45 },
            { img: "instruktor3.png", desc: "Příroda je naše učebna.", likes: 45 },
