...
// zde jsem snížil hodnotu PRESSURE_DISSIPATION z 0.8 na 0.5, aby se tlak déle udržel a vytvořil výraznější efekty
...
function generateColor() {
    return {
        r: 0.015,  // červená složka (vysoká hodnota = více červené)
        g: 0.015,  // zelená složka (vysoká hodnota = světlo)
        b: 0.015   // modrá složka (trochu modré pro neonový nádech)
    };
}
